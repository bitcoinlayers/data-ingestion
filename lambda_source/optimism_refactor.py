...
def lambda_handler(event, context):
    ...
    optimism_rpc_url = f"https://opt-mainnet.g.alchemy.com/v2/{api_secret.get('API_KEY_ALCHEMY')}"
    ...
    block_number = get_block_by_timestamp(end_timestamp, optimism_rpc_url)
